      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="<?php echo  base_url() ?>addstaff" method="post" id='stafffrm' name='stafffrm'>
              <div class="box-body">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="tel" class="form-control" id="phone" placeholder="enter number" name="phone" placeholder="Enter mobile number without country code"  />
            </div>
          </div>
        </div>
