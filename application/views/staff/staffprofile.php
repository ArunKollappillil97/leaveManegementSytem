      ...
      function  fetchcategory($value)
  {
    ...
    <section class="content-header">
     ...
     <?php $idd=$this->session->userdata('user_id');?>
       <a class="btn btn-info" href="<?php echo base_url('StaffController/profileview/'."$idd" .''); ?>">View Profile</a>
 <br>
      <ol class="breadcrumb">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="<?php echo  base_url() ?>updatestaff"  method="post" id='registration'name='registration'>
        ...
        <div class="row">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="designation" value="<?php echo $row->designation?>" placeholder="enter university "  name="designation" readonly/>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
         ...
         <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              <label for="name" >Photo<span class="required-star"></span></label >
