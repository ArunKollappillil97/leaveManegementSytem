         ...
         {  
            ?>
                  <tr>
                    ...
                    <td><a class="btn btn-success" href="<?php echo base_url('HRcontroller/leaveaccept/'. $result['leave_id'].''); ?>">Accept</a> <a  class="btn btn-danger" href="<?php echo base_url('HRcontroller/leavereject/'. $result['leave_id'].''); ?>">Reject</a></td> 
                  </tr>
             <?php 
             $i++;}  
         ?>  
